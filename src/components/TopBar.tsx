...
export function TopBar({ children, progress }: { children?: ReactChild, progress?: number }) {
    return (
        <div data-tauri-drag-region className='flex gap-2 h-[38px]'>
            <div className="flex px-2 pb-1 mt-3 justify-around" data-tauri-drag-region>
                <div className="flex gap-1" data-tauri-drag-region>
                    ...
                    <div className="mx-2 flex justify-around flex-col text-standard-bold text-status-success bg-status-success bg-opacity-20 rounded-lg px-3" data-tauri-drag-region>
                        v1.5.2
                    </div>
                </div>
            </div>
            <div className="flex flex-grow flex-col justify-center px-10 h-full" data-tauri-drag-region>
