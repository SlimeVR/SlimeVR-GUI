...
export function TopBar({ children, progress }: { children?: ReactChild, progress?: number }) {
    return (
        <div data-tauri-drag-region className='flex gap-2 h-[38px]'>
            <div className="flex px-2 py-2 pt-3 justify-around" data-tauri-drag-region>
                <div className="flex gap-1" data-tauri-drag-region>
                    ...
                    <div className="flex justify-around flex-col text-sm text-accent-background-60 bg-accent-background-60 bg-opacity-20 rounded-lg px-2" data-tauri-drag-region>v1.5.2</div>
                </div>
            </div>
            <div className="flex flex-grow flex-col justify-center px-10" data-tauri-drag-region>
                {progress !== undefined &&<ProgressBar progress={progress} height={3}></ProgressBar>}
            </div>
