...
export function SettingsSidebar() {
    return (
        <div className="flex flex-col px-8 w-72 gap-8 my-10 overflow-y-auto border-background-30 border-r">
            <div className="flex flex-col gap-3 text-section-indicator">
