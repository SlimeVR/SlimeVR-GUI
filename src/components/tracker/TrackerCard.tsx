    ...
    <div className="flex flex-col justify-center rounded-md py-3 pr-4 pl-4 w-full gap-2 box-border my-8 px-6 h-52">
      ...
      <div className="flex justify-center text-default gap-2">
        <div className="flex flex-col justify-center">
          <div
            className={classNames('w-2 h-2 rounded-full', statusClass)}
          ></div>
        </div>
          ...
          <>
            ...
            <div className="flex gap-2">
              ...
              {device.hardwareStatus.ping && (
                <div className="flex">{device.hardwareStatus.ping} ms</div>
              )}
            </div>
          </>
        )}
...
function TrackerSmol({
  ...
  return (
    <div className="flex flex-col justify-center rounded-md py-3 pr-4 pl-4 w-full gap-2 box-border my-8 px-6 h-52"></div>
  );
}
